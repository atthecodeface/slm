...
// None of the kernel-density filters below trap for bounds exceedance |x|>w.
...
///
/// Compute the 1d raw (unnormalized) histogram of an sl_array data vector.
///
...
///
/// Compute the 2d raw (unnormalized) histogram of a joint sl_array data-pair vector.
///
/// Compiled if KERNEL_HISTOGRAM_BIVARIATE is defined.
///
/// @param[in]     sl_array          (float2 *, RO):
/// @param[in,out] histogram_array   (uint *,   RW):
///
/// @returns void
///
