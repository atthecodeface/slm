...
# -*- coding: utf-8 -*-
#
# Streamlines documentation build configuration file, created by
# sphinx-quickstart on Sun Jan  7 11:04:24 2018.
#
...
htmlhelp_basename = 'Streamlinesdoc'
...
latex_documents = [
    (master_doc, 'Streamlines.tex', 'Streamlines Documentation',
     'CPS', 'manual'),
]
...
man_pages = [
    (master_doc, 'streamlines', 'Streamlines Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Streamlines', 'Streamlines Documentation',
     author, 'Streamlines', 'Trace streamlines on DTMs.',
     'Miscellaneous'),
]
